...
module.exports = {
  ...
  // 小程序菊花码图片
  mpcode_img: "cloud://yun01-8gnfwx4e248a6ac4.7975-yun01-8gnfwx4e248a6ac4-1309624129/系统/菊花码.jpg",
  ...
  text: {
    ...
    reward: {
      ...
      reward_tip: "您的捐款及广告收入将用作猫猫救助，每月的收支都会在小程序公开栏进行公开，感谢您对流浪猫的帮助与支持！\n喵(^･ｪ･^)",
      reward_count_tip: "* 每月统计一次，在公开栏公示，多谢晒（鞠躬）",
      reward_title: "爱心捐款",
    },
    ...
    feedback: {
      ...
      contract_tip: "有关猫猫信息添加、小程序的建议、照片维权、猫猫领养咨询等事项，请置邮：nickmechlin01@outlook.com",
    },
    // 开发团队页，pages/info/devTeam/devTeam
    dev_team: {
      share_tip: "关于我们",
      team: "程序开发：中大猫谱、Zervan\n资料维护：Zervan\n以及猫狗协会的小伙伴~\n非常欢迎新朋友加入设计开发哇~！",
    },
