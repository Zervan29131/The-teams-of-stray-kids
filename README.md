...
<img src="./readme/twl.jpeg" width = "200" height = "200" alt="中大猫谱菊花码" />
...
| :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|                          华农喵星人                          |                           汇景猫党                           |                         HNU喵汪图鉴                          |
| <img src="./readme/qrcodeCMZJ.png" width = "200" height = "200" alt="财猫之家菊花码" /> | <img src="./readme/qrcodeESMY.jpg" width = "200" height = "200" alt="二师猫语菊花码" /> | <img src="./readme/qrcode1.png" width = "200" height = "200" alt="中大猫谱菊花码" /> |
|                           财猫之家                           |                           二师猫语                           |                                                              |

如果，你所在校园（/社团/小区...）的猫猫:smile_cat:也盼望拥有一份属于自己的猫猫档案，请你跟随下一章节的指引，为它们部署、发布一份独特的图谱小程序。

* 发邮件至：nickmechlin01@outlook.com
* 在GitHub页面提issue
